...
<body>
    ...
    <%
        List<Logintable> list = new ArrayList<>();
        //ArrayList list = (ArrayList) request.getAttribute("loginbean");
        list= (List<Logintable>) request.getSession().getAttribute("loginbean");
        Logintable loginBean = null;
        for (int i = 0; i < list.size(); i++) {
            loginBean = (Logintable) list.get(i);
    %>
    <tr valign="middle">
